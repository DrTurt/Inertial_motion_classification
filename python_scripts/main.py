...
def run_parameter_optimisation(dfs, model_no=0, all=False):
    ...
    for data_frame in dfs:
        if model_no == 0 or all:
            print("Running grid search for {} classifier, on {} dataset".format(model_names[0], df_names[count]))
        ...
        if model_no == 1 or all:
            print("Running grid search for {} classifier, on {} dataset".format(model_names[1], df_names[count]))
        ...
        if model_no == 2 or all:
            print("Running grid search for {} classifier, on {} dataset".format(model_names[2], df_names[count]))
        ...
        if model_no == 3 or all:
            print("Running grid search for {} classifier, on {} dataset".format(model_names[3], df_names[count]))
